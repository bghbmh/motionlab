...
interface Props {
	mode: 'add' | 'edit'
	isRoutine?: boolean   // 알림장 운동 수정 여부 — true면 종류/강도 읽기전용
	initialData?: {
		workout_type?: WorkoutType
		intensity?: string
		logged_at?: string
		duration_min?: number
		prescribed_duration_min?: number   // 알림장 처방 시간
...
export default function WorkoutRecordModal({
	mode,
	isRoutine = false,
	initialData,
	onSave,
